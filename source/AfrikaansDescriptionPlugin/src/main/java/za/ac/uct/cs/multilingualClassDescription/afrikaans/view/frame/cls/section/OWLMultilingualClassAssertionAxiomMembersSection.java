...
import za.ac.uct.cs.multilingualClassDescription.afrikaans.view.frame.cls.section.row.OWLMultilingualClassAssertionAxiomMembersSectionRow;
 ...
 *
 */
public class OWLMultilingualClassAssertionAxiomMembersSection extends AbstractOWLClassAxiomFrameSection<OWLClassAssertionAxiom, OWLNamedIndividual> {

    public static final String LABEL = Utils.getDico().getWord(EnumWord.INSTANCES_LABEL);
    ...
    public OWLMultilingualClassAssertionAxiomMembersSection(OWLEditorKit editorKit, OWLFrame<? extends OWLClass> frame) {
		super(editorKit, LABEL, Utils.getDico().getWord(EnumWord.INSTANCES_ROW_LABEL), frame);
	}
    ...
    protected void addAxiom(OWLClassAssertionAxiom ax, OWLOntology ont) {
        ...
        addRow(new OWLMultilingualClassAssertionAxiomMembersSectionRow(owlEditorKit, this, ont, getRootObject(), ax));
                ...
                for (OWLIndividual ind : instances.getFlattened()) {
                    if (!ind.isAnonymous() && !added.contains(ind.asOWLNamedIndividual())) {
                        addRow(new OWLClassAssertionAxiomMembersSectionRow(getOWLEditorKit(),
                                                                           OWLMultilingualClassAssertionAxiomMembersSection.this,
                                                                           null,
                                                                           getRootObject(),
